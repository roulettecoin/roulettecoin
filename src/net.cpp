...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Roulettecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"roulettecointools.com", "dnsseed.roulettecointools.com"},
    {"roulettecoinpool.org", "dnsseed.roulettecoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"roulettecointools.com", "testnet-seed.roulettecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Roulettecoin is probably already running."), addrBind.ToString().c_str());
        else
